...
if(isset($_POST['pay'])){
    ...
    if(!$result){
        ...
        while($row=mysqli_fetch_array($result)){
            $q1="INSERT into orders(`sno`, `order_id`, `book_id`,
             `book_name`, `img`, `price`, `quantity`, `total_price`,
            ...
            mysqli_stmt_bind_param($stmt1,'isssssissssss',$param_sno,$param_order_id,  $param_book_id,$param_bookname,
