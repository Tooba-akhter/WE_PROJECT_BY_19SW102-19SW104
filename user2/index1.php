...
<div class="col-sm-12">
    ...
    <br>
  <div class = "col-sm-12">
      <div class ="heading" style="margin-top:3%; font-size: 30px;
      ...
      <div class="row ">
          ...
          while($row=mysqli_fetch_array($result)){
              ...
              <div class ="col-sm-3 text-center " id = "product">
                  ...
                  font-family:Verdana ">&#x20b9 '.$row['price'].'</h6>
                  <form method = "post" class="form-item">
                      ...
                      if(!isset($_SESSION['loggedin'])){
                          ...
                          value="ADD TO CART"  class="btn btn-primary login"  style="width:80%; ">';
                            ...
                            $output .=' <button type="button" id="'.$row['book_id'].'" class="btn btn-primary" 
